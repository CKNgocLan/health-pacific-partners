			...
			<div className='grid grid-flow-col-dense justify-items-center text-center mt-10'>
				<div className='px-[3vh] md:w-2/3 lg:w-1/3 lg:text-left'>
					...
					<div className='bg-[#f5f5f5] pt-5 pb-8 mt-3 grid grid-flow-row-dense gap-3'>
						<div
							className={`${styles.contactInfoRow} grid gap-3 md:gap-4`}
						>
							<div
								className={`${styles.contactInfoIcon} text-[#9fb6dd] text-center`}
							>
						...
						<div
							className={`${styles.contactInfoRow} grid gap-3 md:gap-6`}
						>
							<div
								className={`${styles.contactInfoIcon} text-[#9fb6dd] text-center`}
							>
						...
						>
							<div
								className={`${styles.contactInfoIcon} text-[#0d77b4] text-center`}
							>
